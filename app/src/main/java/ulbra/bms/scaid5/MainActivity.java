...
public class MainActivity extends ActionBarActivity implements OnMapReadyCallback,GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener,GoogleMap.OnMarkerClickListener{
    ...
    {
        ArrayList<clsAlertas> exibe = clsAlertas.carregaAlertas();

        //foreach do java
        for (clsAlertas percorre : exibe)
        {
            //adiciona o marcador
            // .icon personaliza o ícone, ver https://developers.google.com/maps/documentation/android/marker#customize_the_marker_image
...
//Métodos criados automaticamente abaixo, onCreate e onConnected foram modificados
    ...
    public void onConnected(Bundle bundle) {
        ...
        LatLng teste = new LatLng(mLastLocation.getLatitude(), mLastLocation.getLongitude());
        //desloca a visualização do mapa para a coordenada informada
        objMapa.moveCamera(CameraUpdateFactory.newLatLngZoom(teste,17));
    }
